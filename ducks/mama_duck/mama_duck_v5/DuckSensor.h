...
public:
    ...
    void processSensorData(SensorData& data) {
        ...
        // Update histories
        updateHistory(data.scaled_temp, data.scaled_humidity, data.scaled_pressure, data.scaled_gas);
        ...
        if (lastSensorTime > 0) {
            ...
            data.gas_velocity = (data.scaled_gas - prev_scaled_gas) / timeIntervalHours;
        }
        ...
        prev_scaled_gas = data.scaled_gas;
    }
};
